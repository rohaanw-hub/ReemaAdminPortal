...
export default function Login() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: '#fff', borderRadius: 16, padding: '48px 48px',
        boxShadow: '0 4px 6px rgba(0,0,0,0.04), 0 12px 40px rgba(227,24,55,0.08)',
        border: '1px solid rgba(227,24,55,0.1)', maxWidth: 420, width: '100%',
      }}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              placeholder="you@reema.com" required
              style={{
        ...
        <div style={{
          ...
          Teachers: use their email / any password<br />
          Parents: use parent email on student record / any password
        </div>
      </div>
    </div>
  )
